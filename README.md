# Schedule Card by [@flotre](https://www.github.com/flotre)
...
| ----------------- | ------- | ------------ | ------------------------------------------- | ------------------- |
| type              | string  | **Required** | `custom:schedule-card`                   |
| id                | string  | **Required** | Card name                                   | ``       |
| title             | string  | **Required** | Show what an error looks like for the card  | ``             |
...
## Starting a new card with [devcontainer][devcontainer]
